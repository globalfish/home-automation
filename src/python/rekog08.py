...
REAR_CAM = 1
XTNL_CAM = 2
flywheelPin = 20 #broadcom pin to start flywheel
triggerPin = 21
...
#vs = VideoCamera(DLINK2312, "192.168.86.147", ('admin', 'f1102cosmos'))
#vs = VideoCamera(DLINK930, "192.168.86.98:45595", ('admin', 'f1102cosmos'))
